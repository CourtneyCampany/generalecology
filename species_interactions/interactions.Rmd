...
<IMG STYLE="position:absolute; TOP:200px; LEFT:50px; WIDTH:1000px; HEIGHT:400px" SRC="images/redsquirell.png">
...
<IMG STYLE="position:absolute; TOP:200px; LEFT:25px; WIDTH:300px; HEIGHT:450px" SRC="images/squirrel.png">
...
<IMG STYLE="position:absolute; TOP:200px; LEFT:200px; WIDTH:700px; HEIGHT:500px" SRC="images/barnacles.jpg">

## Co-existence and natural selection
<hr>

* **Two species whose niches overlap may evolve use the environment differently, resulting in resource partitioning**
...
* **Species whose niches only partly overlap may be able to coexist**
    ...
    + slowly evolve to make use of different/less overlapping resources (character displacement)
    
* **Species which occupy a similar position along one niche dimension may differ along another (niche complementarity)**
...
## Coexissitence through resource partitioning with warblers
<hr>

<IMG STYLE="position:absolute; TOP:200px; LEFT:100px; WIDTH:500px; HEIGHT:500px" SRC="images/avoidance.jpg">

## Niche complementarity: differ in use of microhabitats
<hr>
