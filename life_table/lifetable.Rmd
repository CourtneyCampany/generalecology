...
* **Survivorship x Birthrate (R): # of female young produced per individual**
    + net reproductive rate (age class)
...
* **Population growth parameter (R~o~): Sum of Survivorship x Fecundity**
    ...
    + R~o~ = 2.5 = a lemur produces 2.5 baby lemurs on average in a lifetime