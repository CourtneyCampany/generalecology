...
* **Static life table: Based on age distribution at one point in time**
    + infer survivorship across ages
    + age distribution should be stable (representative)
        + if distorted (recent die-off, immigration) then inferred suvivorship will be biased
...
* **Birthrate per capita (m~x~): average # offspring born to females of each age**
